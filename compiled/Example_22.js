...
var _lucamug$elm_meta_json_decoder$Main$content = F2(
	function (model, formField) {
		...
		switch (_p7.ctor) {
			...
			default:
				return model.fieldProgrammingLanguage;
		}
	});
					...
					_1: {
						...
						_0: {
							...
							_1: _elm_lang$core$Json_Encode$string(
								function () {
									var _p8 = model.fieldDate;
									if (_p8.ctor === 'Just') {
										return _lucamug$elm_meta_json_decoder$Main$formatDate(_p8._0);
									} else {
										return '';
									}
								}())
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'programmingLanguage',
								_1: _elm_lang$core$Json_Encode$string(model.fieldProgrammingLanguage)
							},
							_1: {
								ctor: '::',
								_0: {
									...
									_1: _elm_lang$core$Json_Encode$list(
										A2(
											...
											_lucamug$elm_meta_json_decoder$Main$filteredFruits(model.fieldFruits)))
								},
								_1: {ctor: '[]'}
							}
						}
	...
	function (field, value, model) {
		...
		switch (_p9.ctor) {
			...
			default:
				return _elm_lang$core$Native_Utils.update(
					model,
					{fieldProgrammingLanguage: value});
		}
	});
...
var _lucamug$elm_meta_json_decoder$Main$settings = function () {
...
var _lucamug$elm_meta_json_decoder$Main$exampleVersion = '22';
												...
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return {errors: a, response: b, focus: c, showErrors: d, showPassword: e, formState: f, fieldEmail: g, fieldPassword: h, fieldDate: i, fieldProgrammingLanguage: j, fieldFruits: k, datePicker: l, autocomMenuItems: m, autocomState: n, autocomHowManyToShow: o, autocomSelectedMenuItem: p, autocomShowMenu: q};
																};
															};
														};
													};
...
var _lucamug$elm_meta_json_decoder$Main$setQuery = F2(
	function (model, id) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				fieldProgrammingLanguage: function (_) {
					return _.name;
				}(
...
var _lucamug$elm_meta_json_decoder$Main$init = function () {
	var _p11 = _elm_community$elm_datepicker$DatePicker$init;
	...
	return {
		...
		_0: {
			...
			fieldEmail: '',
			fieldPassword: '',
			fieldDate: _elm_lang$core$Maybe$Nothing,
			fieldProgrammingLanguage: '',
			fieldFruits: _elm_lang$core$Dict$fromList(
				{
					ctor: '::',
...
var _lucamug$elm_meta_json_decoder$Main$OnInput = F2(
	function (a, b) {
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					},
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Native_Utils.eq(field, _lucamug$elm_meta_json_decoder$Main$Password) ? A2(
								_elm_lang$html$Html$div,
								{
									ctor: '::',
										...
										_0: _elm_lang$html$Html_Attributes$classList(
											{
												...
												_1: {
													...
													_0: {
														ctor: '_Tuple2',
														_0: 'upperPosition',
														_1: A2(_lucamug$elm_meta_json_decoder$Main$upperPosition, model, field)
													},
													_1: {ctor: '[]'}
												}
											}),
				...
				_1: {
					ctor: '::',
					_0: A3(_lucamug$elm_meta_json_decoder$Main$viewFormErrors, model, field, model.errors),
					_1: {ctor: '[]'}
				}
			});
	});
...
var _lucamug$elm_meta_json_decoder$Main$updateConfig = _thebritican$elm_autocomplete$Autocomplete$updateConfig(
	{
				...
				return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? A2(
					...
					function (_p16) {
						return _lucamug$elm_meta_json_decoder$Main$MsgAutocom(
							_lucamug$elm_meta_json_decoder$Main$PreviewMenuItem(_p16));
					},
					maybeId) : (_elm_lang$core$Native_Utils.eq(code, 13) ? A2(
					_elm_lang$core$Maybe$map,
					function (_p17) {
						return _lucamug$elm_meta_json_decoder$Main$MsgAutocom(
							_lucamug$elm_meta_json_decoder$Main$SelectMenuItemKeyboard(_p17));
					},
		...
		onTooLow: _elm_lang$core$Maybe$Just(
			function (_p18) {
				return _lucamug$elm_meta_json_decoder$Main$MsgAutocom(
					_lucamug$elm_meta_json_decoder$Main$Wrap(_p18));
			}(false)),
		onTooHigh: _elm_lang$core$Maybe$Just(
			function (_p19) {
				return _lucamug$elm_meta_json_decoder$Main$MsgAutocom(
					_lucamug$elm_meta_json_decoder$Main$Wrap(_p19));
			}(true)),
		onMouseEnter: function (id) {
			return _elm_lang$core$Maybe$Just(
				function (_p20) {
					return _lucamug$elm_meta_json_decoder$Main$MsgAutocom(
						_lucamug$elm_meta_json_decoder$Main$PreviewMenuItem(_p20));
				}(id));
		},
		onMouseLeave: function (_p21) {
			return _elm_lang$core$Maybe$Nothing;
		},
		onMouseClick: function (id) {
			return _elm_lang$core$Maybe$Just(
				function (_p22) {
					return _lucamug$elm_meta_json_decoder$Main$MsgAutocom(
						_lucamug$elm_meta_json_decoder$Main$SelectMenuItemMouse(_p22));
				}(id));
		},
...
var _lucamug$elm_meta_json_decoder$Main$updateAutocom = F2(
	function (msg, model) {
		...
		switch (_p23.ctor) {
			case 'OnInputAutocom':
				var _p25 = _p23._0;
				var autocomShowMenu = function (_p24) {
					return !_elm_lang$core$List$isEmpty(_p24);
				}(
					A2(_lucamug$elm_meta_json_decoder$Main$acceptableItems, _p25, model.autocomMenuItems));
				return {
					ctor: '_Tuple2',
					_0: _lucamug$elm_meta_json_decoder$Main$setErrors(
						A3(
							_lucamug$elm_meta_json_decoder$Main$setField,
							_lucamug$elm_meta_json_decoder$Main$ProgrammingLanguage,
							_p25,
							_elm_lang$core$Native_Utils.update(
								model,
								{fieldProgrammingLanguage: _p25, autocomShowMenu: autocomShowMenu, autocomSelectedMenuItem: _elm_lang$core$Maybe$Nothing}))),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SetAutoState':
				var _p26 = A5(
			...
			case 'SelectMenuItemKeyboard':
				var newModel = _lucamug$elm_meta_json_decoder$Main$resetMenu(
					A2(_lucamug$elm_meta_json_decoder$Main$setQuery, model, _p23._0));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					newModel,
					{ctor: '[]'});
			case 'SelectMenuItemMouse':
				...
				return {
					...
					_1: A2(
						...
						_elm_lang$dom$Dom$focus('item-input'))
				};
			case 'PreviewMenuItem':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							autocomSelectedMenuItem: _elm_lang$core$Maybe$Just(
								A2(_lucamug$elm_meta_json_decoder$Main$getMenuItemAtId, model.autocomMenuItems, _p23._0))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'HandleEscape':
				...
				var escapedModel = function () {
					var _p30 = model.autocomSelectedMenuItem;
					if (_p30.ctor === 'Just') {
						return _elm_lang$core$Native_Utils.eq(model.fieldProgrammingLanguage, _p30._0.name) ? _lucamug$elm_meta_json_decoder$Main$resetInput(model) : handleEscape;
					} else {
						return handleEscape;
					}
				}();
			...
			case 'OnBlurAutocom':
				return A2(
					...
					_lucamug$elm_meta_json_decoder$Main$resetMenu(model));
			default:
...
var _lucamug$elm_meta_json_decoder$Main$update = F2(
	function (msg, model) {
		var _p31 = A2(_elm_lang$core$Debug$log, 'msg', msg);
		switch (_p31.ctor) {
			case 'NoOp':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'SubmitForm':
				var _p32 = _lucamug$elm_meta_json_decoder$Main$validate(model);
				if (_p32.ctor === '[]') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
			...
			case 'OnInput':
				return {
					ctor: '_Tuple2',
					_0: _lucamug$elm_meta_json_decoder$Main$setErrors(
						A3(_lucamug$elm_meta_json_decoder$Main$setField, _p31._0, _p31._1, model)),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Response':
				if (_p31._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								response: _elm_lang$core$Maybe$Just(_p31._0._0),
								formState: _lucamug$elm_meta_json_decoder$Main$Editing
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			case 'ToggleFruit':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							fieldFruits: A2(_lucamug$elm_meta_json_decoder$Main$toggle, _p31._0, model.fieldFruits)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ToDatePicker':
				var _p33 = A3(_elm_community$elm_datepicker$DatePicker$update, _lucamug$elm_meta_json_decoder$Main$settings, _p31._0, model.datePicker);
				var newDatePicker = _p33._0;
				var mDate = _p33._2;
				var date = function () {
					var _p34 = mDate;
					if (_p34.ctor === 'Changed') {
						return _p34._0;
					} else {
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{fieldDate: date, datePicker: newDatePicker}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return A2(_lucamug$elm_meta_json_decoder$Main$updateAutocom, _p31._0, model);
		}
	});
...
var _lucamug$elm_meta_json_decoder$Main$subscriptions = function (model) {
	return A2(
		...
		function (_p35) {
			return _lucamug$elm_meta_json_decoder$Main$MsgAutocom(
				_lucamug$elm_meta_json_decoder$Main$SetAutoState(_p35));
		},
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				function (_p36) {
					return _lucamug$elm_meta_json_decoder$Main$MsgAutocom(
						_lucamug$elm_meta_json_decoder$Main$SetAutoState(_p36));
				},
				A4(
...
var _lucamug$elm_meta_json_decoder$Main$OnInputAutocom = function (a) {
	return {ctor: 'OnInputAutocom', _0: a};
};
var _lucamug$elm_meta_json_decoder$Main$viewAutocom = function (model) {
	var programmingLanguage = function () {
		var _p37 = model.autocomSelectedMenuItem;
		if (_p37.ctor === 'Just') {
			return _p37._0.name;
		} else {
			return model.fieldProgrammingLanguage;
	...
	var fromResult = function (result) {
		var _p38 = result;
		if (_p38.ctor === 'Ok') {
			return _elm_lang$core$Json_Decode$succeed(_p38._0);
		} else {
			return _elm_lang$core$Json_Decode$fail(_p38._0);
		}
	};
	var dec = A2(
		_elm_lang$core$Json_Decode$andThen,
					...
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Events$onInput(
								function (_p39) {
									return _lucamug$elm_meta_json_decoder$Main$MsgAutocom(
										_lucamug$elm_meta_json_decoder$Main$OnInputAutocom(_p39));
								}),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onFocus(
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$id('item-input'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$classList(
														{
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-owns', 'list-of-items'),
															_1: {
																ctor: '::',
																_0: A2(
																	_elm_lang$html$Html_Attributes$attribute,
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													_elm_lang$html$Html$map,
													_lucamug$elm_meta_json_decoder$Main$ToDatePicker,
													A3(_elm_community$elm_datepicker$DatePicker$view, model.fieldDate, _lucamug$elm_meta_json_decoder$Main$settings, model.datePicker)),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$div,
															...
															_0: _elm_lang$html$Html_Attributes$classList(
																{
																	...
																	_1: {
																		...
																		_0: {
																			ctor: '_Tuple2',
																			_0: 'upperPosition',
																			_1: (!_elm_lang$core$Native_Utils.eq(model.fieldDate, _elm_lang$core$Maybe$Nothing)) || _elm_community$elm_datepicker$DatePicker$isOpen(model.datePicker)
																		},
																		_1: {ctor: '[]'}
																	}
																}),
																...
																function () {
																	...
																	if (_p40.ctor === 'Nothing') {
																		...
																		return A2(
																			_elm_lang$core$Basics_ops['++'],
																			'Date: ',
																			_lucamug$elm_meta_json_decoder$Main$formatDate(_p40._0));
																	}
																}()),
															_1: {ctor: '[]'}
														}),
												...
												},
												{
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Date (using type = \"date\")'),
																_1: {ctor: '[]'}
															}),
														_1: {ctor: '[]'}
													}
									...
									_1: {
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
														...
														_1: {
															...
															_0: A2(
																...
																},
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text(
																		A2(_elm_lang$core$Basics_ops['++'], 'Programming Lanugage ', model.fieldProgrammingLanguage)),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}
												...
												_1: {
													ctor: '::',
													_0: A3(_lucamug$elm_meta_json_decoder$Main$viewFormErrors, model, _lucamug$elm_meta_json_decoder$Main$ProgrammingLanguage, model.errors),
													_1: {ctor: '[]'}
												}
											}),
										_1: {
															...
															_1: {
																...
																_0: A2(
																	...
																	},
																	{
																		...
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$value('aaa'),
																				_1: {ctor: '[]'}
																			},
																			{ctor: '[]'}),
																		_1: {
																			...
																			_0: A2(
																				...
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html_Attributes$value('bbb'),
																					_1: {ctor: '[]'}
																				},
																				{ctor: '[]'}),
																			_1: {ctor: '[]'}
																...
																_1: {
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('Programming Language (using <datalist>)'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}
											...
											_1: {
												...
												_0: A2(
													...
													A2(
														_elm_lang$core$List$map,
														function (fruit) {
															var value = A2(_elm_lang$core$Dict$get, fruit, model.fieldFruits);
															var isDisabled = _lucamug$elm_meta_json_decoder$Main$fruitsQuantityHaveReachedTheLimit(model.fieldFruits) && (!A2(_elm_lang$core$Maybe$withDefault, false, value));
														...
														_elm_lang$core$Dict$keys(model.fieldFruits))),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$div,
