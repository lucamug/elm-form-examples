...
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$viewConfig = function () {
	var customizedLi = F3(
...
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$acceptableItems = F2(
...
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$getMenuItemAtId = F2(
...
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$setQuery = F2(
	function (model, id) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				fieldValue: A2(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$getMenuItemAtId, model.menuItems, id),
				selectedMenuItem: _elm_lang$core$Maybe$Just(
					A2(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$getMenuItemAtId, model.menuItems, id))
			});
	});
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$removeSelection = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{selectedMenuItem: _elm_lang$core$Maybe$Nothing});
};
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$resetMenu = function (model) {
	return _elm_lang$core$Native_Utils.update(
		model,
		{state: _thebritican$elm_autocomplete$Autocomplete$empty, showMenu: false});
};
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$resetInput = function (model) {
	return _lucamug$elm_meta_json_decoder$AutocompleteWrapper$resetMenu(
		_lucamug$elm_meta_json_decoder$AutocompleteWrapper$removeSelection(
			_elm_lang$core$Native_Utils.update(
				model,
				{fieldValue: ''})));
};
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$init = F2(
...
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$NoOpAutocom = {ctor: 'NoOpAutocom'};
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$Reset = {ctor: 'Reset'};
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$PreventFocusAndBlur = {ctor: 'PreventFocusAndBlur'};
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$OnBlurAutocom = {ctor: 'OnBlurAutocom'};
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$OnFocusAutocom = {ctor: 'OnFocusAutocom'};
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$HandleEscape = {ctor: 'HandleEscape'};
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$PreviewMenuItem = function (a) {
	return {ctor: 'PreviewMenuItem', _0: a};
};
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$SelectMenuItemMouse = function (a) {
	return {ctor: 'SelectMenuItemMouse', _0: a};
};
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$SelectMenuItemKeyboard = function (a) {
	return {ctor: 'SelectMenuItemKeyboard', _0: a};
};
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$Wrap = function (a) {
	return {ctor: 'Wrap', _0: a};
};
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$updateConfig = F2(
						...
						return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? A2(
							...
							function (_p1) {
								return A2(
									originMessage,
									msgId,
									_lucamug$elm_meta_json_decoder$AutocompleteWrapper$PreviewMenuItem(_p1));
							},
							...
							function (_p2) {
								return A2(
									originMessage,
									msgId,
									_lucamug$elm_meta_json_decoder$AutocompleteWrapper$SelectMenuItemKeyboard(_p2));
							},
							maybeId) : _elm_lang$core$Maybe$Just(
							A2(originMessage, msgId, _lucamug$elm_meta_json_decoder$AutocompleteWrapper$Reset)));
					}),
				onTooLow: _elm_lang$core$Maybe$Just(
					function (_p3) {
						return A2(
							originMessage,
							msgId,
							_lucamug$elm_meta_json_decoder$AutocompleteWrapper$Wrap(_p3));
					}(false)),
				onTooHigh: _elm_lang$core$Maybe$Just(
					function (_p4) {
						return A2(
							originMessage,
							msgId,
							_lucamug$elm_meta_json_decoder$AutocompleteWrapper$Wrap(_p4));
					}(true)),
					...
					return _elm_lang$core$Maybe$Just(
						function (_p7) {
							return A2(
								originMessage,
								msgId,
								_lucamug$elm_meta_json_decoder$AutocompleteWrapper$SelectMenuItemMouse(_p7));
						}(id));
				},
				separateSelections: false
			});
	});
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$update = F4(
			...
			switch (_p8.ctor) {
				case 'SetQuery':
					...
					var showMenu = function (_p9) {
						...
						A2(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$acceptableItems, _p10, model.menuItems));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
				...
				case 'SetAutoState':
					if (!model.focus) {
						...
						var _p11 = A5(
							...
							A2(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$updateConfig, model.fieldId, originMessage),
							_p8._0,
							model.howManyToShow,
							model.state,
							A2(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$acceptableItems, model.fieldValue, model.menuItems));
				...
				case 'Wrap':
					...
					if (_p14.ctor === 'Just') {
						var _v7 = _lucamug$elm_meta_json_decoder$AutocompleteWrapper$Reset,
							_v8 = model,
							_v9 = originMessage,
							_v10 = msgConverter;
						msg = _v7;
				...
				case 'SelectMenuItemKeyboard':
					var newModel = _lucamug$elm_meta_json_decoder$AutocompleteWrapper$resetMenu(
						A2(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$setQuery, model, _p8._0));
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						newModel,
						{ctor: '[]'});
				case 'SelectMenuItemMouse':
					...
					return {
						...
						_1: A2(
							...
							function (_p15) {
								return A2(originMessage, model.fieldId, _lucamug$elm_meta_json_decoder$AutocompleteWrapper$NoOpAutocom);
							},
				...
				case 'PreviewMenuItem':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								selectedMenuItem: _elm_lang$core$Maybe$Just(
									A2(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$getMenuItemAtId, model.menuItems, _p8._0))
							}),
						{ctor: '[]'});
				case 'HandleEscape':
					var validOptions = !_elm_lang$core$List$isEmpty(
						A2(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$acceptableItems, model.fieldValue, model.menuItems));
					var handleEscape = validOptions ? _lucamug$elm_meta_json_decoder$AutocompleteWrapper$resetMenu(
						_lucamug$elm_meta_json_decoder$AutocompleteWrapper$removeSelection(model)) : _lucamug$elm_meta_json_decoder$AutocompleteWrapper$resetInput(model);
					var escapedModel = function () {
						var _p16 = model.selectedMenuItem;
						if (_p16.ctor === 'Just') {
							return _elm_lang$core$Native_Utils.eq(model.fieldValue, _p16._0) ? _lucamug$elm_meta_json_decoder$AutocompleteWrapper$resetInput(model) : handleEscape;
						} else {
							return handleEscape;
						}
					}();
...
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$SetAutoState = function (a) {
	return {ctor: 'SetAutoState', _0: a};
};
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$viewMenu = F2(
			...
			_elm_lang$html$Html$div,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Events$onMouseDown(
						A2(originMessage, model.fieldId, _lucamug$elm_meta_json_decoder$AutocompleteWrapper$PreventFocusAndBlur)),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					...
					function (_p17) {
						return A2(
							originMessage,
							model.fieldId,
							_lucamug$elm_meta_json_decoder$AutocompleteWrapper$SetAutoState(_p17));
					},
					A4(
						_thebritican$elm_autocomplete$Autocomplete$view,
						_lucamug$elm_meta_json_decoder$AutocompleteWrapper$viewConfig,
						model.howManyToShow,
						model.state,
						A2(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$acceptableItems, model.fieldValue, model.menuItems))),
				_1: {ctor: '[]'}
...
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$SetQuery = function (a) {
	return {ctor: 'SetQuery', _0: a};
};
var _lucamug$elm_meta_json_decoder$AutocompleteWrapper$view = F2(
	function (model, originMessage) {
		...
		var menu = model.showMenu ? {
			ctor: '::',
			_0: A2(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$viewMenu, model, originMessage),
			_1: {ctor: '[]'}
		} : {ctor: '[]'};
			...
			A2(
				...
				function (code) {
					return (_elm_lang$core$Native_Utils.eq(code, 38) || _elm_lang$core$Native_Utils.eq(code, 40)) ? _elm_lang$core$Result$Ok(
						A2(originMessage, model.fieldId, _lucamug$elm_meta_json_decoder$AutocompleteWrapper$NoOpAutocom)) : (_elm_lang$core$Native_Utils.eq(code, 27) ? _elm_lang$core$Result$Ok(
						A2(originMessage, model.fieldId, _lucamug$elm_meta_json_decoder$AutocompleteWrapper$HandleEscape)) : _elm_lang$core$Result$Err('not handling that key'));
				},
									...
									_0: _elm_lang$html$Html_Events$onInput(
										function (_p21) {
											return A2(
												originMessage,
												model.fieldId,
												_lucamug$elm_meta_json_decoder$AutocompleteWrapper$SetQuery(_p21));
										}),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onFocus(
											A2(originMessage, model.fieldId, _lucamug$elm_meta_json_decoder$AutocompleteWrapper$OnFocusAutocom)),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onBlur(
												A2(originMessage, model.fieldId, _lucamug$elm_meta_json_decoder$AutocompleteWrapper$OnBlurAutocom)),
											_1: {
												ctor: '::',
...
var _lucamug$elm_meta_json_decoder$Main$menuItems3 = {
	ctor: '::',
	_0: 'Blue',
	_1: {
		ctor: '::',
...
var _lucamug$elm_meta_json_decoder$Main$init = {
	ctor: '_Tuple2',
	_0: {
		field1: A2(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$init, 'id1', _lucamug$elm_meta_json_decoder$Main$menuItems1),
		field2: A2(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$init, 'id2', _lucamug$elm_meta_json_decoder$Main$menuItems2),
		field3: A2(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$init, 'id3', _lucamug$elm_meta_json_decoder$Main$menuItems3)
	},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _lucamug$elm_meta_json_decoder$Main$Model = F3(
	function (a, b, c) {
		return {field1: a, field2: b, field3: c};
	});
var _lucamug$elm_meta_json_decoder$Main$OriginMessage = F2(
	function (a, b) {
...
var _lucamug$elm_meta_json_decoder$Main$update = F2(
	function (msg, model) {
		...
		if (_elm_lang$core$Native_Utils.eq(fieldId, model.field1.fieldId)) {
			var _p2 = A4(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$update, autocomMsg, model.field1, _lucamug$elm_meta_json_decoder$Main$OriginMessage, msgConverter);
			var newModel = _p2._0;
			var newMsg = _p2._1;
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
			...
			if (_elm_lang$core$Native_Utils.eq(fieldId, model.field2.fieldId)) {
				var _p3 = A4(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$update, autocomMsg, model.field2, _lucamug$elm_meta_json_decoder$Main$OriginMessage, msgConverter);
				var newModel = _p3._0;
				var newMsg = _p3._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
				...
				if (_elm_lang$core$Native_Utils.eq(fieldId, model.field3.fieldId)) {
					var _p4 = A4(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$update, autocomMsg, model.field3, _lucamug$elm_meta_json_decoder$Main$OriginMessage, msgConverter);
					var newModel = _p4._0;
					var newMsg = _p4._1;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_1: {
								ctor: '::',
								_0: A2(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$view, model.field1, _lucamug$elm_meta_json_decoder$Main$OriginMessage),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_1: {
									ctor: '::',
									_0: A2(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$view, model.field2, _lucamug$elm_meta_json_decoder$Main$OriginMessage),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_1: {
										ctor: '::',
										_0: A2(_lucamug$elm_meta_json_decoder$AutocompleteWrapper$view, model.field3, _lucamug$elm_meta_json_decoder$Main$OriginMessage),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: A2(
				...
				function (_p5) {
					return A2(
						_lucamug$elm_meta_json_decoder$Main$OriginMessage,
						model.field1.fieldId,
						_lucamug$elm_meta_json_decoder$AutocompleteWrapper$SetAutoState(_p5));
				},
				...
				_0: A2(
					...
					function (_p6) {
						return A2(
							...
							_lucamug$elm_meta_json_decoder$AutocompleteWrapper$SetAutoState(_p6));
					},
					_thebritican$elm_autocomplete$Autocomplete$subscription),
				_1: {
					ctor: '::',
					_0: A2(
						...
						function (_p7) {
							return A2(
								...
								_lucamug$elm_meta_json_decoder$AutocompleteWrapper$SetAutoState(_p7));
						},
						_thebritican$elm_autocomplete$Autocomplete$subscription),
					_1: {ctor: '[]'}
				}
