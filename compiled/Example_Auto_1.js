...
var _lucamug$elm_meta_json_decoder$Main$acceptableItems = F2(
	function (field2, autocomMenuItems) {
		var lowerQuery = _elm_lang$core$String$toLower(field2);
		return A2(
					...
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {focus: a, field1: b, field2: c, field3: d, autocomMenuItems: e, autocomState: f, autocomHowManyToShow: g, autocomSelectedMenuItem: h, autocomShowMenu: i, autocomFocus: j};
									};
								};
							};
						};
...
var _lucamug$elm_meta_json_decoder$Main$init = {
	ctor: '_Tuple2',
	_0: {field1: '', field3: '', field2: '', focus: _elm_lang$core$Maybe$Nothing, autocomMenuItems: _lucamug$elm_meta_json_decoder$Main$menuItems, autocomState: _thebritican$elm_autocomplete$Autocomplete$empty, autocomHowManyToShow: 10, autocomSelectedMenuItem: _elm_lang$core$Maybe$Nothing, autocomShowMenu: false, autocomFocus: false},
...
var _lucamug$elm_meta_json_decoder$Main$Field3 = {ctor: 'Field3'};
...
var _lucamug$elm_meta_json_decoder$Main$updateConfig = _thebritican$elm_autocomplete$Autocomplete$updateConfig(
	{
		...
		onMouseEnter: function (id) {
			return _elm_lang$core$Maybe$Just(
				function (_p6) {
					return _lucamug$elm_meta_json_decoder$Main$MsgAutocom(
						_lucamug$elm_meta_json_decoder$Main$PreviewMenuItem(_p6));
				}(id));
		},
		...
		switch (_p9.ctor) {
			case 'SetQuery':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{field2: _p11, autocomShowMenu: autocomShowMenu, autocomSelectedMenuItem: _elm_lang$core$Maybe$Nothing}),
					{ctor: '[]'});
			case 'SetAutoState':
				var _p12 = A5(
					...
					model.autocomState,
					A2(_lucamug$elm_meta_json_decoder$Main$acceptableItems, model.field2, model.autocomMenuItems));
			...
			case 'HandleEscape':
				...
				var escapedModel = function () {
					...
					if (_p16.ctor === 'Just') {
						return _elm_lang$core$Native_Utils.eq(model.field2, _p16._0.name) ? _lucamug$elm_meta_json_decoder$Main$resetInput(model) : handleEscape;
					} else {
						return handleEscape;
					}
				}();
...
var _lucamug$elm_meta_json_decoder$Main$viewAutocom = function (model) {
	var activeDescendant = function (attributes) {
		...
		if (_p20.ctor === 'Just') {
			return {
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-activedescendant', _p20._0.name),
				_1: attributes
			};
		} else {
			return attributes;
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(field2),
												_1: {
													ctor: '::',
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], 'Field 1: ', model.field1)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], 'Field 2: ', model.field2)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(_elm_lang$core$Basics_ops['++'], 'Field 3: ', model.field3)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
														...
														_0: A2(
															_elm_lang$html$Html$input,
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onInput(
																		_lucamug$elm_meta_json_decoder$Main$SetField(_lucamug$elm_meta_json_decoder$Main$Field3)),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Events$onFocus(
																			_lucamug$elm_meta_json_decoder$Main$OnFocus(_lucamug$elm_meta_json_decoder$Main$Field3)),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onBlur(
																				_lucamug$elm_meta_json_decoder$Main$OnBlur(_lucamug$elm_meta_json_decoder$Main$Field3)),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$value(model.field3),
																				_1: {
																					ctor: '::',
...
var _lucamug$elm_meta_json_decoder$Main$view = function (model) {
	return _lucamug$elm_meta_json_decoder$Main$viewForm(model);
};
