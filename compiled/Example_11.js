...
var _lucamug$elm_meta_json_decoder$Main$exampleVersion = '11';
...
var _lucamug$elm_meta_json_decoder$Main$viewInput = F4(
	function (model, formField, inputType, inputName) {
		var hasFocus = function () {
			var _p5 = model.focus;
			if (_p5.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.eq(_p5._0, formField);
			} else {
				return false;
			}
		}();
...
if (typeof _lucamug$elm_meta_json_decoder$Main$main !== 'undefined') {
    _lucamug$elm_meta_json_decoder$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Main.Msg":{"args":[],"tags":{"OnFocus":["Main.FormField"],"SetField":["Main.FormField","String"],"Response":["Result.Result Http.Error String"],"SubmitForm":[],"OnBlur":["Main.FormField"],"NoOp":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Main.FormField":{"args":[],"tags":{"Email":[],"Password":[]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
