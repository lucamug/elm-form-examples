...
var _lucamug$elm_meta_json_decoder$Main$exampleVersion = '12';
var _lucamug$elm_meta_json_decoder$Main$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {errors: a, email: b, password: c, response: d, focus: e, showErrors: f, showPassword: g};
	});
