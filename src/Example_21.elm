...
updateAutocom msg model =
    case msg of
        SetQuery newQuery ->
            ...
            in
            { model | programmingLanguage = newQuery, autocomShowMenu = autocomShowMenu, autocomSelectedMenuItem = Nothing } ! []

        SetAutoState autoMsg ->
            let
                ( newState, maybeMsg ) =
                    Autocomplete.update updateConfig autoMsg model.autocomHowManyToShow model.autocomState (acceptableItems model.programmingLanguage model.autocomMenuItems)
        ...
        Wrap toTop ->
            case model.autocomSelectedMenuItem of
                ...
                Nothing ->
                    if toTop then
                        { model
                            | autocomState = Autocomplete.resetToLastItem updateConfig (acceptableItems model.programmingLanguage model.autocomMenuItems) model.autocomHowManyToShow model.autocomState
                            , autocomSelectedMenuItem = List.head <| List.reverse <| List.take model.autocomHowManyToShow <| acceptableItems model.programmingLanguage model.autocomMenuItems
                        }
                            ! []
                    else
                        { model
                            | autocomState = Autocomplete.resetToFirstItem updateConfig (acceptableItems model.programmingLanguage model.autocomMenuItems) model.autocomHowManyToShow model.autocomState
                            , autocomSelectedMenuItem = List.head <| List.take model.autocomHowManyToShow <| acceptableItems model.programmingLanguage model.autocomMenuItems
                        }
                            ! []
        ...
        HandleEscape ->
            let
                validOptions =
                    not <| List.isEmpty (acceptableItems model.programmingLanguage model.autocomMenuItems)
                ...
                escapedModel =
                    case model.autocomSelectedMenuItem of
                        Just menuItem ->
                            if model.programmingLanguage == menuItem.name then
                                model
                                    |> resetInput
                            else
                                handleEscape
...
setQuery model id =
    { model
        | programmingLanguage = .name <| getMenuItemAtId model.autocomMenuItems id
...
viewMenu model =
    div [ class "autocomplete-menu" ]
        [ Html.map (MsgAutocom << SetAutoState) (Autocomplete.view viewConfig model.autocomHowManyToShow model.autocomState (acceptableItems model.programmingLanguage model.autocomMenuItems)) ]
